> Source: `sources/eval/README.md` · split by content type
> Section kept: whole
> Do NOT edit content — pending web verification.

# Evaluation Benchmark Sources (`sources/eval/`)

> Held-out test sets, safety suites, and constraint compliance benchmarks for evaluating foundation models in low-resource Nepali.

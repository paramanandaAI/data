> Source: `sources/pretrain/README.md` · split by content type
> Section kept: guide
> Do NOT edit content — pending web verification.

# Pretraining Corpora Sources (`sources/pretrain/`)

> Monolingual web text, news dumps, Wikipedia archives, and cleaned Devanagari web corpora for foundation model pretraining and masked language modeling.

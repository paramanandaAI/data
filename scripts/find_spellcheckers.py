    ...
    try:
        with open(p, 'r', encoding='utf-8', errors='ignore') as f:
            ...
            for idx, line in enumerate(lines, 1):
                if re.search(r'\b(spylls|hunspell|spellcheck|spellchecker|spelling)\b', line, re.IGNORECASE):
...
print(f"Found {len(matches)} occurrences of spellchecker/hunspell/spylls in .py files:")
print("=" * 100)
